...
class Mixlib::ShellOut
  ...
  #   cmd.run_command # etc.
  #
  # pkg:gem/mixlib-shellout#lib/mixlib/shellout.rb:172
  def initialize(*command_args); end

  # Path to cgroupv2 that the process should run on
  #
  # pkg:gem/mixlib-shellout#lib/mixlib/shellout.rb:118
  def cgroup; end
  ...
  #
  # pkg:gem/mixlib-shellout#lib/mixlib/shellout.rb:84
  def command; end

  # Working directory for the subprocess. Normally set via options to new
  #
  # pkg:gem/mixlib-shellout#lib/mixlib/shellout.rb:54
  def cwd; end
  ...
  #
  # pkg:gem/mixlib-shellout#lib/mixlib/shellout.rb:113
  def elevated; end
  ...
  #
  # pkg:gem/mixlib-shellout#lib/mixlib/shellout.rb:91
  def environment; end
  ...
  #
  # pkg:gem/mixlib-shellout#lib/mixlib/shellout.rb:290
  def error!; end
  ...
  # otherwise.
  #
  # pkg:gem/mixlib-shellout#lib/mixlib/shellout.rb:281
  def error?; end

  # The amount of time the subcommand took to execute
  #
  # pkg:gem/mixlib-shellout#lib/mixlib/shellout.rb:98
  ...
  # `kill -9`).
  #
  # pkg:gem/mixlib-shellout#lib/mixlib/shellout.rb:254
  def exitstatus; end
  ...
  #
  # pkg:gem/mixlib-shellout#lib/mixlib/shellout.rb:238
  ...
  #
  # pkg:gem/mixlib-shellout#lib/mixlib/shellout.rb:224
  def gid; end

  # Group the command will run as. Normally set via options passed to new
  #
  # pkg:gem/mixlib-shellout#lib/mixlib/shellout.rb:51
  def group; end
  ...
  # Default: nil
  #
  # pkg:gem/mixlib-shellout#lib/mixlib/shellout.rb:71
  def input; end
  ...
  # pkg:gem/mixlib-shellout#lib/mixlib/shellout.rb:307
  def inspect; end
  ...
  #
  # pkg:gem/mixlib-shellout#lib/mixlib/shellout.rb:302
  ...
  #
  # pkg:gem/mixlib-shellout#lib/mixlib/shellout.rb:66
  def live_stderr; end
  ...
  # as the subprocess is running.
  #
  # pkg:gem/mixlib-shellout#lib/mixlib/shellout.rb:62
  def live_stdout; end
  ...
  #
  # pkg:gem/mixlib-shellout#lib/mixlib/shellout.rb:195
  def live_stream; end
  ...
  #
  # pkg:gem/mixlib-shellout#lib/mixlib/shellout.rb:202
  def live_stream=(stream); end

  # The log level at which ShellOut should log.
  #
  # pkg:gem/mixlib-shellout#lib/mixlib/shellout.rb:78
  def log_level; end
  ...
  #
  # pkg:gem/mixlib-shellout#lib/mixlib/shellout.rb:81
  def log_tag; end
  ...
  # command.
  #
  # pkg:gem/mixlib-shellout#lib/mixlib/shellout.rb:75
  def logger; end
  ...
  #
  # pkg:gem/mixlib-shellout#lib/mixlib/shellout.rb:48
  def login; end
  ...
  # pkg:gem/mixlib-shellout#lib/mixlib/shellout.rb:110
  ...
  #
  # pkg:gem/mixlib-shellout#lib/mixlib/shellout.rb:269
  def run_command; end

  # pkg:gem/mixlib-shellout#lib/mixlib/shellout.rb:115
  def sensitive; end
  ...
  # reaped.
  #
  # pkg:gem/mixlib-shellout#lib/mixlib/shellout.rb:108
  def status; end

  # Data written to stderr by the subprocess
  #
  # pkg:gem/mixlib-shellout#lib/mixlib/shellout.rb:104
  def stderr; end
  ...
  #
  # pkg:gem/mixlib-shellout#lib/mixlib/shellout.rb:101
  def stdout; end
  ...
  # to new
  #
  # pkg:gem/mixlib-shellout#lib/mixlib/shellout.rb:231
  def timeout; end

  # The maximum time this command is allowed to run. Usually set via options
  # to new
  #
  # pkg:gem/mixlib-shellout#lib/mixlib/shellout.rb:95
  ...
  #
  # pkg:gem/mixlib-shellout#lib/mixlib/shellout.rb:58
  ...
  # TODO remove
  #
  # pkg:gem/mixlib-shellout#lib/mixlib/shellout.rb:44
  def with_logon; end
  ...
  # pkg:gem/mixlib-shellout#lib/mixlib/shellout.rb:316
  def parse_options(opts); end

  # pkg:gem/mixlib-shellout#lib/mixlib/shellout.rb:372
...
# pkg:gem/mixlib-shellout#lib/mixlib/shellout.rb:27
...
module Mixlib::ShellOut::Unix
  ...
  #
  # pkg:gem/mixlib-shellout#lib/mixlib/shellout/unix.rb:93
  def run_command; end
  ...
  #
  # pkg:gem/mixlib-shellout#lib/mixlib/shellout/unix.rb:51
  def sgids; end

  # Whether we're simulating a login shell
  #
  # pkg:gem/mixlib-shellout#lib/mixlib/shellout/unix.rb:33
  def using_login?; end

  # Option validation that is unix specific
  #
  # pkg:gem/mixlib-shellout#lib/mixlib/shellout/unix.rb:26
  def validate_options(opts); end

  private

  # pkg:gem/mixlib-shellout#lib/mixlib/shellout/unix.rb:280
  def attempt_buffer_read(timeout = T.unsafe(nil)); end

  # Try to reap the child process but don't block if it isn't dead yet.
  #
  # pkg:gem/mixlib-shellout#lib/mixlib/shellout/unix.rb:417
  def attempt_reap; end

  # pkg:gem/mixlib-shellout#lib/mixlib/shellout/unix.rb:319
  ...
  #
  # pkg:gem/mixlib-shellout#lib/mixlib/shellout/unix.rb:193
  def child_pgid; end

  # pkg:gem/mixlib-shellout#lib/mixlib/shellout/unix.rb:214
  def child_process_status; end

  # pkg:gem/mixlib-shellout#lib/mixlib/shellout/unix.rb:210
  def child_stderr; end

  # pkg:gem/mixlib-shellout#lib/mixlib/shellout/unix.rb:202
  def child_stdin; end

  # pkg:gem/mixlib-shellout#lib/mixlib/shellout/unix.rb:206
  def child_stdout; end

  # pkg:gem/mixlib-shellout#lib/mixlib/shellout/unix.rb:218
  def close_all_pipes; end

  # pkg:gem/mixlib-shellout#lib/mixlib/shellout/unix.rb:251
  ...
  #
  # pkg:gem/mixlib-shellout#lib/mixlib/shellout/unix.rb:230
  def configure_subprocess_file_descriptors; end

  # pkg:gem/mixlib-shellout#lib/mixlib/shellout/unix.rb:323
  def fork_subprocess; end

  # pkg:gem/mixlib-shellout#lib/mixlib/shellout/unix.rb:197
  def initialize_ipc; end

  # Some patch levels of ruby in wide use (in particular the ruby 1.8.6 on OSX)
  # segfault when you IO.select a pipe that's reached eof. Weak sauce.
  #
  # pkg:gem/mixlib-shellout#lib/mixlib/shellout/unix.rb:268
  def open_pipes; end
  ...
  #
  # pkg:gem/mixlib-shellout#lib/mixlib/shellout/unix.rb:367
  def propagate_pre_exec_failure; end

  # pkg:gem/mixlib-shellout#lib/mixlib/shellout/unix.rb:310
  def read_process_status_to_buffer; end

  # pkg:gem/mixlib-shellout#lib/mixlib/shellout/unix.rb:300
  def read_stderr_to_buffer; end

  # pkg:gem/mixlib-shellout#lib/mixlib/shellout/unix.rb:290
  ...
  #
  # pkg:gem/mixlib-shellout#lib/mixlib/shellout/unix.rb:404
  def reap; end

  # pkg:gem/mixlib-shellout#lib/mixlib/shellout/unix.rb:378
  def reap_errant_child; end

  # pkg:gem/mixlib-shellout#lib/mixlib/shellout/unix.rb:181
  def set_cgroup; end

  # pkg:gem/mixlib-shellout#lib/mixlib/shellout/unix.rb:177
  def set_cwd; end

  # pkg:gem/mixlib-shellout#lib/mixlib/shellout/unix.rb:166
  def set_environment; end

  # pkg:gem/mixlib-shellout#lib/mixlib/shellout/unix.rb:153
  def set_group; end

  # pkg:gem/mixlib-shellout#lib/mixlib/shellout/unix.rb:160
  def set_secondarygroups; end

  # pkg:gem/mixlib-shellout#lib/mixlib/shellout/unix.rb:173
  def set_umask; end

  # pkg:gem/mixlib-shellout#lib/mixlib/shellout/unix.rb:146
  def set_user; end

  # pkg:gem/mixlib-shellout#lib/mixlib/shellout/unix.rb:396
  def should_reap?; end

  # Keep this unbuffered for now
  #
  # pkg:gem/mixlib-shellout#lib/mixlib/shellout/unix.rb:273
